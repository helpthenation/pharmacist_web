    ...
    def notification_on_partner_as_a_seller(self):
        ...
        for user_obj in self:
            if user_obj.partner_id.seller:
                ...
                if config_setting_obj["enable_notify_admin_4_new_seller"] and config_setting_obj.has_key("notify_admin_4_new_seller") and config_setting_obj["notify_admin_4_new_seller"]:
                ...
                if config_setting_obj["enable_notify_seller_4_new_seller"] and config_setting_obj.has_key("notify_seller_4_new_seller") and config_setting_obj["notify_seller_4_new_seller"]:
